...
import ela1 from "@/assets/valentine1.jpeg";
import ela2 from "@/assets/ela2.png";
import ela3 from "@/assets/valentine4.jpeg";
import ela4 from "@/assets/valentine3.jpeg";
import ela5 from "@/assets/valentine2.jpeg";
import minionLovesGif from "@/assets/minion-loves.gif";
import song from "@/assets/songforvalentine.mp3";
...
const Valentine = () => {
  ...
  const phrases = [
    "Hey you... 💕",
    "Najua umengoja hiii for the longest time... 😅.....but here it is",
    "Will you be my Valentine? 💘",
    "It's a yes or no answer... IF YOU KNOW YOU KNOW 😏",
  ];
  ...
  useEffect(() => {
    // Create audio element from bundled asset and try safe autoplay
    audioRef.current = new Audio(song);
    audioRef.current.loop = true;

    // Delay autoplay attempt by 8 seconds to avoid immediate browser blocks
    const autoplayTimer = window.setTimeout(() => {
      ...
      if (playPromise !== undefined) {
        playPromise
          ...
          .catch(() => {
            // Autoplay was prevented by browser; remain paused until user interaction
            setIsPlaying(false);
          });
      }
    }, 8000);
